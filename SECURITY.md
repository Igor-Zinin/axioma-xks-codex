...
1. **GitHub Private Advisory** (preferred): Go to [Security → Advisories → New draft](https://github.com/Igor-Zinin/game-codex/security/advisories/new) and submit a private draft.
